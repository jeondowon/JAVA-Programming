...
public class Rep05NewHangman3 {
    public static void main(String[] args){
        Scanner sc = new Scanner(System.in);
        boolean quit = false;
        String answer;
        do{
            NewHangman3 game = new NewHangman3();
            game.initialize("I'will be back");
...
class NewHangman3{
    ...
    private char[] wrongWords = new char[100];
